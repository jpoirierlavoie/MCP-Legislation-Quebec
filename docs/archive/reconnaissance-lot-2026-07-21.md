...
- **45 textes**, 0 téléchargement(s) FR en échec.
- **EN disponible pour 45/45** textes — aucun 404 EN.
- **parse_epub réussit sur 45/45** textes (extraction des articles OK partout). Le décompte parseur = scan + 1 (pseudo-article « préliminaire »).
- **À traiter en phase C (motifs non standard) :**
  ...
  - **Annexes/formulaires structurels** (intitulés hors article `se:`) — non capturés : ['c-25.01-r.0.2.2', 'c-25.01-r.0.2.3', 'c-25.01-r.9', 't-16', 'c-12', 'i-16', 'c-25.01-r.0.2.4', 'c-25.01-r.0.2.1', 'j-3', 'i-13.2.2', 'b-9', 't-15.01-r.5', 't-15.01', 'p-40.1', 'b-1', 'c-1.1', 'c-19', 'c-26', 'e-6.1', 'i-14.01', 'n-1.1', 'p-39.1', 'p-44.1', 't-11.002', 'a-2.1', 'f-2.1', 'c-25.1', 'ccq-r.8', 'ccq-r.6', 'a-33.01'].
  - **Blocs `sc-nb:1` non extraits** (le parseur les étiquette « finales » mais le texte est vide — p. ex. section FORMULES) : —.
  - **id `Note`** (note éditoriale, à exclure du `text` comme les notes A.M.) : ['t-16-r.10', 'j-3-r.3.2', 'i-13.2.2', 't-15.01-r.5', 't-15.01', 't-15.01-r.6', 'b-1', 'c-38', 'e-6.1', 'f-2.1'].
...
| t-16 | loi | fr+en | 527 | 1..283 +244déc | 76 | — | 7 bloc(s) | ✓ 534a/83d | 1 |
| t-16-r.10 | tarif | fr+en | 29 | 1..29 | 0 | 5 | — | ✓ 29a/0d | 2 |
| c-12 | loi | fr+en | 162 | 1..139 +23déc | 21 | — | 3 bloc(s) | ✓ 165a/24d | 1 |
| i-16 | loi | fr+en | 73 | 1..63 +10déc | 8 | — | 2 bloc(s) | ✓ 75a/10d | 1 |
| c-25.01-r.0.2.4 | regles-procedure | fr+en | 48 | 1..43 +5déc | 18 | — | 10 bloc(s) | ✓ 58a/28d | 1 |
| c-25.01-r.0.2.1 | regles-procedure | fr+en | 77 | 1..76 +1déc | 15 | — | 1 bloc(s) | ✓ 78a/16d | 1 |
| j-3 | loi | fr+en | 219 | 1..201 +18déc | 42 | — | 5 bloc(s) | ✓ 224a/47d | 1 |
...
| b-9 | loi | fr+en | 62 | 1..51 +11déc | 0 | — | 4 bloc(s) | ✓ 68a/6d | 1 |
| t-15.01-r.5 | regles-procedure | fr+en | 71 | 1..64 +7déc | 30 | — | 6 bloc(s) | ✓ 77a/36d | 2 |
| t-15.01 | loi | fr+en | 233 | 1..147 +86déc | 28 | — | 2 bloc(s) | ✓ 236a/31d | 2 |
| t-15.01-r.6 | tarif | fr+en | 9 | 1..9 | 2 | — | — | ✓ 9a/2d | 1 |
| p-40.1 | loi | fr+en | 631 | 1..364 +267déc | 56 | — | 15 bloc(s) | ✓ 647a/72d | 1 |
| b-1 | loi | fr+en | 166 | 1..143 +23déc | 31 | — | 2 bloc(s) | ✓ 168a/33d | 2 |
...
| c-19 | loi | fr+en | 1283 | 1..662 +621déc | 118 | — | 2 bloc(s) | ✓ 1322a/157d | 1 |
| c-26 | loi | fr+en | 481 | 1..199 +282déc | 43 | — | 3 bloc(s) | ✓ 484a/46d | 1 |
| c-38 | loi | fr+en | 493 | 1..234 +259déc | 104 | — | — | ✓ 494a/105d | 1 |
| c-73.2 | loi | fr+en | 207 | 1..162 +45déc | 32 | — | — | ✓ 207a/32d | 0 |
| e-6.1 | loi | fr+en | 932 | 1..750 +182déc | 124 | — | 3 bloc(s) | ✓ 936a/128d | 2 |
...
| n-1.1 | loi | fr+en | 352 | 1..172 +180déc | 41 | — | 1 bloc(s) | ✓ 354a/43d | 1 |
| p-39.1 | loi | fr+en | 179 | 1..115 +64déc | 29 | — | 1 bloc(s) | ✓ 180a/30d | 1 |
| p-44.1 | loi | fr+en | 323 | 0..302 +21déc | 53 | — | 5 bloc(s) | ✓ 328a/58d | 2 |
| s-31.1 | loi | fr+en | 732 | 1..729 +3déc | 164 | — | — | ✓ 732a/164d | 0 |
| t-11.002 | loi | fr+en | 176 | 1..176 | 50 | — | 1 bloc(s) | ✓ 177a/51d | 1 |
| v-1.1 | loi | fr+en | 645 | 1..354 +291déc | 77 | — | — | ✓ 646a/78d | 0 |
| a-2.1 | loi | fr+en | 268 | 1..183 +85déc | 34 | — | 2 bloc(s) | ✓ 271a/37d | 1 |
| a-32.1 | loi | fr+en | 577 | 1..554 +23déc | 203 | — | — | ✓ 577a/203d | 0 |
| f-2.1 | loi | fr+en | 1007 | 1..591 +416déc | 127 | — | 1 bloc(s) | ✓ 1009a/129d | 2 |
| c-25.1 | loi | fr+en | 496 | 1..403 +93déc | 58 | — | 1 bloc(s) | ✓ 498a/60d | 1 |
| c-67.3 | loi | fr+en | 955 | 1..731 +224déc | 113 | — | — | ✓ 956a/114d | 0 |
| ccq-r.8 | reglement | fr+en | 101 | 1..53 +48déc | 22 | — | 17 bloc(s) | ✓ 118a/39d | 1 |
| ccq-r.6 | reglement | fr+en | 101 | 1..94 +7déc | 25 | — | 1 bloc(s) | ✓ 102a/26d | 1 |
| a-33.01 | loi | fr+en | 25 | 1..24 +1déc | 6 | — | 1 bloc(s) | ✓ 26a/7d | 1 |
...
- **parse_epub** : 17 articles, 9 divisions, dispositions=—
...
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 1 · sc-nb:1 : 1 (« ANNEXE 1(a. 1.1)RÈGLEMENT DE LA COUR SUP ») · préliminaire : False · finales : True
- **parse_epub** : 31 articles, 26 divisions, dispositions=—
...
- **parse_epub** : 173 articles, 52 divisions, dispositions=—
...
- **Articles** : 527 (entiers 1..283, 283 distincts, 244 décimaux)
...
- **parse_epub** : 534 articles, 83 divisions, dispositions=—
...
- **parse_epub** : 165 articles, 24 divisions, dispositions=—
...
- **parse_epub** : 75 articles, 10 divisions, dispositions=—
...
- **parse_epub** : 58 articles, 28 divisions, dispositions=—
...
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 1 · sc-nb:1 : 1 (« ANNEXE 1(a. 1.1)RÈGLEMENT DE LA COUR SUP ») · préliminaire : False · finales : True
- **parse_epub** : 78 articles, 16 divisions, dispositions=—
...
- **parse_epub** : 224 articles, 47 divisions, dispositions=—
...
- **parse_epub** : 361 articles, 82 divisions, dispositions=—
...
- **parse_epub** : 68 articles, 6 divisions, dispositions=—
...
- **parse_epub** : 77 articles, 36 divisions, dispositions=—
...
- **parse_epub** : 236 articles, 31 divisions, dispositions=—
...
- **parse_epub** : 647 articles, 72 divisions, dispositions=—
...
- **parse_epub** : 168 articles, 33 divisions, dispositions=—
...
- **parse_epub** : 107 articles, 23 divisions, dispositions=—
...
- **Articles** : 1283 (entiers 1..662, 662 distincts, 621 décimaux)
...
- **parse_epub** : 1322 articles, 157 divisions, dispositions=—
...
- **Articles** : 481 (entiers 1..199, 199 distincts, 282 décimaux)
...
- **parse_epub** : 484 articles, 46 divisions, dispositions=—
...
- **parse_epub** : 494 articles, 105 divisions, dispositions=—
...
- **parse_epub** : 936 articles, 128 divisions, dispositions=—
...
- **parse_epub** : 690 articles, 43 divisions, dispositions=—
...
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 1 · sc-nb:1 : 1 (« ANNEXE ABROGATIVE ») · préliminaire : False · finales : False
- **parse_epub** : 275 articles, 53 divisions, dispositions=—
...
- **Articles** : 352 (entiers 1..172, 172 distincts, 180 décimaux)
...
- **parse_epub** : 354 articles, 43 divisions, dispositions=—
...
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 1 · sc-nb:1 : 1 (« ANNEXE ABROGATIVE ») · préliminaire : False · finales : True
- **parse_epub** : 180 articles, 30 divisions, dispositions=—
...
- **parse_epub** : 328 articles, 58 divisions, dispositions=—
...
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 1 · sc-nb:1 : 1 (« ANNEXE ABROGATIVE ») · préliminaire : False · finales : False
- **parse_epub** : 177 articles, 51 divisions, dispositions=—
- **Renvois RLRQ** : 4 cibles (top : V-1.1×2, I-14.01×1, S-29.02×1, I-13.2.2×1)
- **Anomalies / à traiter en phase C** :
  - 1 intitulé(s) structurel(s) annexe/formulaire HORS article — extraction dédiée à prévoir (non capturée par le parseur actuel)

### v-1.1 — Loi sur les valeurs mobilières
*RLRQ, c. V-1.1 · fonction=loi · kind_epub=cs*
- **Langues** : fr, en
- **name_en (OPF)** : Securities Act
- **Parent (via rlrq_cite)** : v-1.1
- **Articles** : 645 (entiers 1..354, 354 distincts, 291 décimaux)
- **Divisions** : 77 {'chapitre': 18, 'livre': 12, 'section': 5, 'sous-section': 4, 'titre': 38}
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 0 · sc-nb:1 : 1 (« ANNEXES ABROGATIVES ») · préliminaire : False · finales : False
- **parse_epub** : 646 articles, 78 divisions, dispositions=—
- **Renvois RLRQ** : 24 cibles (top : E-6.1×17, I-14.01×8, D-9.2×6, A-2.1×6, I-13.2.2×4, C-67.3×3)

### a-2.1 — Loi sur l’accès aux documents des organismes publics et sur la protection des renseignements personnels
*RLRQ, c. A-2.1 · fonction=loi · kind_epub=cs*
- **Langues** : fr, en
- **name_en (OPF)** : Act respecting Access to documents held by public bodies and the Protection of personal information
- **Parent (via rlrq_cite)** : a-2.1
- **Articles** : 268 (entiers 1..183, 183 distincts, 85 décimaux)
- **Divisions** : 34 {'chapitre': 13, 'livre': 9, 'titre': 12}
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 2 · sc-nb:1 : 1 (« ANNEXE A ») · préliminaire : False · finales : False
- **parse_epub** : 271 articles, 37 divisions, dispositions=—
- **Renvois RLRQ** : 29 cibles (top : C-26×5, R-22.1×5, E-20.1×5, A-21.1×4, P-39.1×4, T-16×2)
- **Anomalies / à traiter en phase C** :
  - 2 intitulé(s) structurel(s) annexe/formulaire HORS article — extraction dédiée à prévoir (non capturée par le parseur actuel)

### a-32.1 — Loi sur les assureurs
*RLRQ, c. A-32.1 · fonction=loi · kind_epub=cs*
- **Langues** : fr, en
- **name_en (OPF)** : Insurers Act
- **Parent (via rlrq_cite)** : a-32.1
- **Articles** : 577 (entiers 1..554, 554 distincts, 23 décimaux)
- **Divisions** : 203 {'chapitre': 82, 'livre': 8, 'section': 50, 'sous-section': 6, 'titre': 57}
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 0 · sc-nb:1 : 0 · préliminaire : False · finales : True
- **parse_epub** : 577 articles, 203 divisions, dispositions=—
- **Renvois RLRQ** : 21 cibles (top : S-31.1×49, D-9.2×8, E-6.1×7, A-32×7, P-44.1×6, J-3×5)

### f-2.1 — Loi sur la fiscalité municipale
*RLRQ, c. F-2.1 · fonction=loi · kind_epub=cs*
- **Langues** : fr, en
- **name_en (OPF)** : Act respecting municipal taxation
- **Parent (via rlrq_cite)** : f-2.1
- **Articles** : 1007 (entiers 1..591, 591 distincts, 416 décimaux)
- **Divisions** : 127 {'chapitre': 53, 'livre': 24, 'section': 10, 'sous-section': 3, 'titre': 37}
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 1 · sc-nb:1 : 1 (« ANNEXE ADISPOSITIONS LÉGISLATIVES ABROGÉ ») · préliminaire : False · finales : True
- **parse_epub** : 1009 articles, 129 divisions, dispositions=—
- **Renvois RLRQ** : 47 cibles (top : M-14×18, I-3×12, A-18.1×9, P-41.1×8, I-13.3×7, E-16×6)
- **Anomalies / à traiter en phase C** :
  - 1 intitulé(s) structurel(s) annexe/formulaire HORS article — extraction dédiée à prévoir (non capturée par le parseur actuel)
  - ids de motif inconnu : {'Note': 1}

### c-25.1 — Code de procédure pénale
*RLRQ, c. C-25.1 · fonction=loi · kind_epub=cs*
- **Langues** : fr, en
- **name_en (OPF)** : Code of Penal Procedure
- **Parent (via rlrq_cite)** : c-25.1
- **Articles** : 496 (entiers 1..403, 403 distincts, 93 décimaux)
- **Divisions** : 58 {'chapitre': 2, 'livre': 16, 'titre': 40}
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 1 · sc-nb:1 : 1 (« ANNEXE(Article 336)DÉTERMINATION DE L’ÉQ ») · préliminaire : False · finales : False
- **parse_epub** : 498 articles, 60 divisions, dispositions=['annexe']
- **Renvois RLRQ** : 29 cibles (top : C-24.2×11, C-25.01×10, P-15×4, C-12×3, G-1.021×1, S-4.2×1)
- **Anomalies / à traiter en phase C** :
  - 1 intitulé(s) structurel(s) annexe/formulaire HORS article — extraction dédiée à prévoir (non capturée par le parseur actuel)

### c-67.3 — Loi sur les coopératives de services financiers
*RLRQ, c. C-67.3 · fonction=loi · kind_epub=cs*
- **Langues** : fr, en
- **name_en (OPF)** : Act respecting financial services cooperatives
- **Parent (via rlrq_cite)** : c-67.3
- **Articles** : 955 (entiers 1..731, 731 distincts, 224 décimaux)
- **Divisions** : 113 {'chapitre': 29, 'livre': 22, 'titre': 62}
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 0 · sc-nb:1 : 1 (« ANNEXES ABROGATIVES ») · préliminaire : False · finales : False
- **parse_epub** : 956 articles, 114 divisions, dispositions=—
- **Renvois RLRQ** : 29 cibles (top : C-4.1×14, I-13.2.2×7, P-44.1×5, F-3.2.0.4×4, E-6.1×3, J-3×3)

### ccq-r.8 — Règlement sur le registre des droits personnels et réels mobiliers
*RLRQ, c. CCQ, r. 8 · fonction=reglement · kind_epub=cr*
- **Langues** : fr, en
- **name_en (OPF)** : Regulation respecting the register of personal and movable real rights
- **Parent (via rlrq_cite)** : —
- **Articles** : 101 (entiers 1..53, 53 distincts, 48 décimaux)
- **Divisions** : 22 {'chapitre': 2, 'livre': 8, 'titre': 12}
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 17 · sc-nb:1 : 1 (« ANNEXE I ») · préliminaire : False · finales : False
- **parse_epub** : 118 articles, 39 divisions, dispositions=—
- **Renvois RLRQ** : 1 cibles (top : C-25.01×1)
- **Anomalies / à traiter en phase C** :
  - 17 intitulé(s) structurel(s) annexe/formulaire HORS article — extraction dédiée à prévoir (non capturée par le parseur actuel)

### ccq-r.6 — Règlement sur la publicité foncière
*RLRQ, c. CCQ, r. 6 · fonction=reglement · kind_epub=cr*
- **Langues** : fr, en
- **name_en (OPF)** : Regulation respecting land registration
- **Parent (via rlrq_cite)** : —
- **Articles** : 101 (entiers 1..94, 94 distincts, 7 décimaux)
- **Divisions** : 25 {'livre': 5, 'titre': 20}
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 1 · sc-nb:1 : 1 (« ANNEXE(a. 83) ») · préliminaire : False · finales : False
- **parse_epub** : 102 articles, 26 divisions, dispositions=['annexe']
- **Renvois RLRQ** : 5 cibles (top : CCQ-1991×11, B-9×8, M-30×1, C-1.1×1, I-16×1)
- **Anomalies / à traiter en phase C** :
  - 1 intitulé(s) structurel(s) annexe/formulaire HORS article — extraction dédiée à prévoir (non capturée par le parseur actuel)

### a-33.01 — Loi favorisant l’augmentation du capital des petites et moyennes entreprises
*RLRQ, c. A-33.01 · fonction=loi · kind_epub=cs*
- **Langues** : fr, en
- **name_en (OPF)** : Act to promote the capitalization of small and medium-sized businesses
- **Parent (via rlrq_cite)** : a-33.01
- **Articles** : 25 (entiers 1..24, 24 distincts, 1 décimaux)
- **Divisions** : 6 {'livre': 6}
- **Tableaux (contenu)** : 0 (dont 0 dans un article) · intitulés annexe/formulaire hors article : 1 · sc-nb:1 : 1 (« ANNEXE ABROGATIVE ») · préliminaire : False · finales : True
- **parse_epub** : 26 articles, 7 divisions, dispositions=—
- **Renvois RLRQ** : 2 cibles (top : I-3×3, R-3×1)
- **Anomalies / à traiter en phase C** :
  - 1 intitulé(s) structurel(s) annexe/formulaire HORS article — extraction dédiée à prévoir (non capturée par le parseur actuel)
