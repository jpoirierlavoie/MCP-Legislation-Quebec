...
- **À traiter en phase C (motifs non standard) :**
  - **Tableaux de contenu** (tarifs surtout) : ['t-16-r.10']. Rendre les tables lisiblement dans `text`, conserver le HTML dans `html`.
  - **Annexes/formulaires hors `sc-nb:1`** (règlements de cour) — non capturés actuellement : annexes ['c-25.01-r.0.2.01'] ; formulaires ['c-25.01-r.0.2.01', 'c-25.01-r.0.2.4'].
...
|---|---|---|---|---|---|---|---|---|---|
| c-25.01-r.0.2.01 | regles-procedure | fr+en | 93 | 1..93 | 21 | — | A3/F1 | ✓ 93a/21d | 2 |
| c-25.01-r.0.2.2 | regles-procedure | fr+en | 16 | 1..15 +1déc | 8 | — | A1/F0 | ✓ 17a/9d | 0 |
| c-25.01-r.0.2.3 | regles-procedure | fr+en | 30 | 1..29 +1déc | 25 | — | A1/F0 | ✓ 31a/26d | 0 |
| c-25.01-r.9 | regles-procedure | fr+en | 172 | 1..169 +3déc | 51 | — | A1/F0 | ✓ 173a/52d | 0 |
| t-16 | loi | fr+en | 526 | 1..283 +243déc | 76 | — | A7/F0 | ✓ 527a/77d | 0 |
| t-16-r.10 | tarif | fr+en | 29 | 1..29 | 0 | 5 | — | ✓ 29a/0d | 2 |
| c-12 | loi | fr+en | 162 | 1..139 +23déc | 21 | — | A3/F0 | ✓ 163a/22d | 0 |
| i-16 | loi | fr+en | 73 | 1..63 +10déc | 8 | — | A2/F0 | ✓ 74a/9d | 0 |
| c-25.01-r.0.2.4 | regles-procedure | fr+en | 48 | 1..43 +5déc | 18 | — | A1/F9 | ✓ 49a/19d | 1 |
| c-25.01-r.0.2.1 | regles-procedure | fr+en | 77 | 1..76 +1déc | 15 | — | A1/F0 | ✓ 78a/16d | 0 |
| j-3 | loi | fr+en | 219 | 1..201 +18déc | 42 | — | A5/F0 | ✓ 220a/43d | 0 |
| j-3-r.3.01 | regles-procedure | fr+en | 42 | 1..42 | 18 | — | — | ✓ 42a/18d | 0 |
| j-3-r.3.2 | tarif | fr+en | 12 | 1..12 | 7 | — | — | ✓ 12a/7d | 1 |
| i-13.2.2 | loi | fr+en | 360 | 1..59 +301déc | 81 | — | A1/F0 | ✓ 361a/82d | 1 |
| b-9 | loi | fr+en | 62 | 1..51 +11déc | 0 | — | A3/F0 | ✓ 63a/1d | 1 |
| t-15.01-r.5 | regles-procedure | fr+en | 71 | 1..64 +7déc | 30 | — | A6/F0 | ✓ 72a/31d | 1 |
| t-15.01 | loi | fr+en | 233 | 1..147 +86déc | 28 | — | A2/F0 | ✓ 234a/29d | 1 |
| t-15.01-r.6 | tarif | fr+en | 9 | 1..9 | 2 | — | — | ✓ 9a/2d | 1 |
| p-40.1 | loi | fr+en | 631 | 1..364 +267déc | 56 | — | A15/F0 | ✓ 632a/57d | 0 |
| b-1 | loi | fr+en | 166 | 1..143 +23déc | 31 | — | A2/F0 | ✓ 167a/32d | 1 |
| b-1-r.3.1 | reglement | fr+en | 157 | 1..155 +2déc | 43 | — | — | ✓ 157a/43d | 0 |
| b-1-r.5 | reglement | fr+en | 87 | 1..87 | 23 | — | — | ✓ 87a/23d | 0 |
| c-1.1 | loi | fr+en | 106 | 1..105 +1déc | 22 | — | A1/F0 | ✓ 107a/23d | 0 |
| c-19 | loi | fr+en | 1234 | 1..662 +572déc | 118 | — | A1/F0 | ✓ 1235a/119d | 0 |
| c-26 | loi | fr+en | 479 | 1..199 +280déc | 43 | — | A3/F0 | ✓ 480a/44d | 0 |
| c-38 | loi | fr+en | 493 | 1..234 +259déc | 104 | — | — | ✓ 494a/105d | 1 |
| c-73.2 | loi | fr+en | 207 | 1..162 +45déc | 32 | — | — | ✓ 207a/32d | 0 |
| e-6.1 | loi | fr+en | 932 | 1..750 +182déc | 124 | — | A3/F0 | ✓ 933a/125d | 1 |
| d-9.2 | loi | fr+en | 689 | 1..583 +106déc | 42 | — | — | ✓ 690a/43d | 0 |
| e-12.000001 | loi | fr+en | 106 | 1..86 +20déc | 23 | — | — | ✓ 106a/23d | 0 |
| i-14.01 | loi | fr+en | 274 | 1..240 +34déc | 52 | — | A1/F0 | ✓ 275a/53d | 0 |
| n-1.1 | loi | fr+en | 345 | 1..172 +173déc | 41 | — | A1/F0 | ✓ 346a/42d | 0 |
| p-39.1 | loi | fr+en | 179 | 1..115 +64déc | 29 | — | A1/F0 | ✓ 180a/30d | 0 |
| p-44.1 | loi | fr+en | 323 | 0..302 +21déc | 53 | — | A5/F0 | ✓ 324a/54d | 1 |
| s-31.1 | loi | fr+en | 732 | 1..729 +3déc | 164 | — | — | ✓ 732a/164d | 0 |
| t-11.002 | loi | fr+en | 176 | 1..176 | 50 | — | A1/F0 | ✓ 177a/51d | 0 |
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 3 · FORMULAIRE : 1 · sc-nb:1 : 0 · préliminaire : False · finales : False
- **parse_epub** : 93 articles, 21 divisions, dispositions=—, texte vide=0
- **Renvois RLRQ** : 5 cibles (top : C-25.01×7, I-16×1, T-16, r. 10×1, CCQ-1991×1, C-25.01, r. 10×1)
- **Anomalies / à traiter en phase C** :
  - ANNEXE/SCHEDULE détecté (3 occ.) hors bloc sc-nb:1 — le parseur ne le capture PAS actuellement (à traiter en phase C)
  - formulaire(s) détecté(s) (1 occ.) — extraction dédiée à prévoir
...
- **Divisions** : 8 {'livre': 8}
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 1 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 17 articles, 9 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 1 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 31 articles, 26 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 1 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 173 articles, 52 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 7 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 527 articles, 77 divisions, dispositions=['annexe'], texte vide=0
...
- **Divisions** : 0 
- **Tableaux** : 5 (dont 5 dans un article) · ANNEXE/SCHEDULE : 0 · FORMULAIRE : 0 · sc-nb:1 : 0 · préliminaire : False · finales : False
- **parse_epub** : 29 articles, 0 divisions, dispositions=—, texte vide=0
- **Renvois RLRQ** : 7 cibles (top : C-25.01×4, C-24.2×1, P-2.2×1, N-2×1, E-19×1, T-15.01×1)
- **Anomalies / à traiter en phase C** :
  - 5 tableau(x), dont 5 dans un article — rendu texte à confirmer (tarif)
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 3 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 163 articles, 22 divisions, dispositions=['annexe'], texte vide=0
...
- **Divisions** : 8 {'livre': 8}
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 2 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : False
- **parse_epub** : 74 articles, 9 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 1 · FORMULAIRE : 9 · sc-nb:1 : 2 · préliminaire : False · finales : True
- **parse_epub** : 49 articles, 19 divisions, dispositions=['annexe'], texte vide=0
- **Renvois RLRQ** : 6 cibles (top : C-25.01×4, P-34.1×2, G-1.021×2, S-4.2×2, R-9×1, C-25.01, r. 6×1)
- **Anomalies / à traiter en phase C** :
  - formulaire(s) détecté(s) (9 occ.) — extraction dédiée à prévoir
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 1 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 78 articles, 16 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 5 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 220 articles, 43 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 0 · FORMULAIRE : 0 · sc-nb:1 : 0 · préliminaire : False · finales : False
- **parse_epub** : 42 articles, 18 divisions, dispositions=—, texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 0 · FORMULAIRE : 0 · sc-nb:1 : 0 · préliminaire : False · finales : False
- **parse_epub** : 12 articles, 7 divisions, dispositions=—, texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 1 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 361 articles, 82 divisions, dispositions=['annexe'], texte vide=0
...
- **Divisions** : 0 
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 3 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : False
- **parse_epub** : 63 articles, 1 divisions, dispositions=['finales'], texte vide=1
- **Renvois RLRQ** : 17 cibles (top : C-25.01×2, A-6.001×2, N-3×1, L-0.1×1, S-11.0101×1, P-9.002×1)
- **Anomalies / à traiter en phase C** :
  - 1 article(s) au texte vide après parse
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 6 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 72 articles, 31 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 2 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : False
- **parse_epub** : 234 articles, 29 divisions, dispositions=['annexe'], texte vide=0
...
- **Divisions** : 2 {'livre': 2}
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 0 · FORMULAIRE : 0 · sc-nb:1 : 0 · préliminaire : False · finales : False
- **parse_epub** : 9 articles, 2 divisions, dispositions=—, texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 15 · FORMULAIRE : 0 · sc-nb:1 : 8 · préliminaire : False · finales : False
- **parse_epub** : 632 articles, 57 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 2 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 167 articles, 32 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 0 · FORMULAIRE : 0 · sc-nb:1 : 0 · préliminaire : False · finales : True
- **parse_epub** : 157 articles, 43 divisions, dispositions=—, texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 0 · FORMULAIRE : 0 · sc-nb:1 : 0 · préliminaire : False · finales : False
- **parse_epub** : 87 articles, 23 divisions, dispositions=—, texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 1 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : False
- **parse_epub** : 107 articles, 23 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 1 · FORMULAIRE : 0 · sc-nb:1 : 11 · préliminaire : False · finales : False
- **parse_epub** : 1235 articles, 119 divisions, dispositions=['finales'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 3 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 480 articles, 44 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 0 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 494 articles, 105 divisions, dispositions=['finales'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 0 · FORMULAIRE : 0 · sc-nb:1 : 0 · préliminaire : False · finales : False
- **parse_epub** : 207 articles, 32 divisions, dispositions=—, texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 3 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : False
- **parse_epub** : 933 articles, 125 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 0 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : False
- **parse_epub** : 690 articles, 43 divisions, dispositions=['finales'], texte vide=0
...
- **Divisions** : 23 {'livre': 11, 'titre': 12}
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 0 · FORMULAIRE : 0 · sc-nb:1 : 0 · préliminaire : False · finales : True
- **parse_epub** : 106 articles, 23 divisions, dispositions=—, texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 1 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : False
- **parse_epub** : 275 articles, 53 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 1 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : False
- **parse_epub** : 346 articles, 42 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 1 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : True
- **parse_epub** : 180 articles, 30 divisions, dispositions=['annexe'], texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 5 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : False
- **parse_epub** : 324 articles, 54 divisions, dispositions=['annexe'], texte vide=0
- **Renvois RLRQ** : 65 cibles (top : P-45×12, S-31.1×8, C-38×7, I-3×6, A-2.1×5, R-17.1×5)
- **Anomalies / à traiter en phase C** :
  - numérotation atypique : 323 se: mais 303 entiers distincts + 21 décimaux (renumérotation par partie ?)
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 0 · FORMULAIRE : 0 · sc-nb:1 : 0 · préliminaire : False · finales : False
- **parse_epub** : 732 articles, 164 divisions, dispositions=—, texte vide=0
...
- **Tableaux** : 0 (dont 0 dans un article) · ANNEXE/SCHEDULE : 1 · FORMULAIRE : 0 · sc-nb:1 : 1 · préliminaire : False · finales : False
- **parse_epub** : 177 articles, 51 divisions, dispositions=['annexe'], texte vide=0
